...
class Worker extends BaseService {
    ...
    _start() {
        ...
        const statsd_config = this.config.metrics.find((o) => {
            return o.type === 'statsd';
        });
        if (statsd_config) {
            this._statsd = makeStatsD(statsd_config, this._logger);
        }
        ...
        this._heapwatchHandle = new HeapWatch(
            { limitMB },
            this._logger,
            this._statsd,
            this._prometheus
