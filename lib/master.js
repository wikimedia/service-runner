...
const MetricsEndpoint = require('./prometheus_server');
...
class Master extends BaseService {
    ...
    _start() {
        ...
        if (prometheus_config) {
            this.metricsEndpoint = new MetricsEndpoint(prometheus_config, this.config.num_workers);
        }
